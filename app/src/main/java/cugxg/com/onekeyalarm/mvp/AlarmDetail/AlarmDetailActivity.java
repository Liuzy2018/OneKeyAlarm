...
public class AlarmDetailActivity extends BaseActivity {
    ...
    public void onCreateActivity(@Nullable Bundle savedInstanceState) {
        ...
        AlarmDetailFragment fragment =
                (AlarmDetailFragment) getSupportFragmentManager().findFragmentById(R.id.contentFrame);
        if (fragment == null) {
            // Create the fragment
            fragment = AlarmDetailFragment.newInstance();
            ActivityUtils.addFragmentToActivity(
                    getSupportFragmentManager(), fragment, R.id.contentFrame);
        }
        new AlarmDetailPresenter(fragment, new CaseRepository());
